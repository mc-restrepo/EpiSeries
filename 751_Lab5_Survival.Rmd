...
# install.packages("devtools", repos="https://www.r-project.org/nosvn/pandoc/devtools.html") #THIS DIDN'T WORK
#install.packages("devtools") THIS WORKED INSTEAD
...
library(ggplot2)
library(devtools)
#install_github('kassambara/survminer') #this didn't work
#install.packages("survminer")
library(survminer) #this worked instead
#install.packages("cmprsk", repos="https://cran.r-project.org/web/packages/cmprsk/index.html") #THIS DIDN'T WORK
#install.packages("cmprsk") #this worked instead
library(cmprsk)
...
setwd("/Users/***/Desktop") #this command sets the working directory where files are read from and where files are outputted
